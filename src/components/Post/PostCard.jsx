      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          ...
          <div
            ...
            className={cn("mt-1 cursor-pointer", "text-(--text-primary)", "[&>*:not(:first-child)]:mt-2.5")}
            dangerouslySetInnerHTML={{ __html: "Có những nỗi nhớ không cần lý do, chỉ cần một bản nhạc." }}
          />
          ...
          <div className="mt-1.5 -mb-1 -ml-3 flex items-center">
            ...
            <Button
              variant="ghost"
              size="icon"
              className={cn("h-9 gap-1 px-3 text-[13px] tabular-nums", liked && "text-(--liked-text)")}
              onClick={handleLike}
            >
